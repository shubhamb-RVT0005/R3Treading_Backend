...
public class OtpService {
    ...
    private String getRedisKey(
        ...
        return "otp:" + userId + ":" + otpType.name();
    }
    ...
    public OtpResponse generateOtp(
        ...
        try {
            ...
            // =================================================
            // SAVE OTP IN REDIS FOR 60 SECONDS
            // =================================================
...
//Existing code Without Redis changes add config ,and application propertioes nad add chngea in serrvice must add Maven repo 
